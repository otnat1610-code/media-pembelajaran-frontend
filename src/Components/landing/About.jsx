        ...
        <div className="flex flex-col md:flex-row gap-16 items-center">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <p className="text-ink-soft text-lg leading-relaxed">
              Media pembelajaran interaktif yang dirancang untuk membantu siswa
              kelas IV SDN Tambahrejo 02 mempelajari sejarah kerajaan di
              Indonesia dengan cara yang lebih menarik, mudah dipahami, dan
              menyenangkan.
            </p>

            <p className="text-ink-soft text-lg leading-relaxed">
              Materi yang disajikan mengacu pada Buku IPAS Kelas IV, khususnya
              Bab 5 pada semester 2, yang membahas sejarah kerajaan di
              Indonesia. Materi dikemas dalam bentuk motion graphic agar siswa
              lebih mudah memahami perkembangan kerajaan Hindu, Buddha, dan
              Islam di Indonesia.
            </p>
