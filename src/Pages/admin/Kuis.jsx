...
export default function Kuis() {
  ...
  const fetchKuis = async () => {
    try {
      ...
      console.log("DATA KUIS ADMIN:", response.data);
  ...
  const createKuisFormData = (
    ...
    // ===================================================
    // DURASI TETAP 10 MENIT
    // TIDAK ADA INPUT DURASI DI FORM
    // ===================================================

    formData.append("durasi", "10");
            ...
            >
              ...
              <div className="mt-4 rounded-xl border border-orange-200 bg-orange-50 px-4 py-3">
                ...
                <div className="mt-1 text-sm text-orange-600">
                  Kuis memiliki durasi tetap 10 menit.
                </div>
          ...
          <div className="mx-auto w-full max-w-6xl rounded-2xl bg-white shadow-xl">
            ...
            >
              ...
              <div className="mt-4 rounded-xl border border-orange-200 bg-orange-50 px-4 py-3">
                ...
                <div className="mt-1 text-sm text-orange-600">
                  Durasi kuis tetap 10 menit dan tidak perlu diubah.
                </div>
